...
class OccMamba(BEVDepth):
    ...
    def extract_pts_feat(self, pts):
        ...
        return pts_enc_feats['x'], pts_enc_feats['pts_feats']
    ...
    def extract_feat(self, points, img, img_metas):
        ...
        if self.occ_fuser is not None:
            voxel_feats = self.occ_fuser(img_voxel_feats, pts_voxel_feats, img_metas=img_metas)
        else:
        ...
        if self.occ_encoder_backbone is not None and self.occ_encoder_neck is not None:
            voxel_feats = self.occ_encoder(voxel_feats)
