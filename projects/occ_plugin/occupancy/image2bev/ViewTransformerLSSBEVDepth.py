...
class DepthNet(nn.Module):
    def __init__(self, in_channels, mid_channels, context_channels,
                 ...
                 norm_cfg_depthNet_BN=dict(type='GN', num_groups=9, requires_grad=True)):
        ...
        self.bn = build_norm_layer(norm_cfg_depthNet_BN, cam_channels)[1]
...
class ViewTransformerLSSBEVDepth(ViewTransformerLiftSplatShoot):
    def __init__(self, loss_depth_weight, cam_channels=27, loss_depth_reg_weight=0.0, use_voxel_net=False, 
                 ...
                 norm_cfg_depthNet_BN=dict(type='GN', num_groups=9, requires_grad=True), **kwargs):
        ...
        self.depth_net = DepthNet(self.numC_input, self.numC_input,
                                  ...
                                  norm_cfg=norm_cfg, norm_cfg_depthNet_BN=norm_cfg_depthNet_BN)
